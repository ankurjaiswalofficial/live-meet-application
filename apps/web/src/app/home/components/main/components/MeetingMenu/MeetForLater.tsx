    ...
    return (
        <Dialog>
            ...
            <DialogContent className="min-w-72 max-w-96">
                <DialogHeader>
                    <DialogTitle className="text-3xl font-medium text-start">
                        Here&apos;s your joining information
                    </DialogTitle>
                    <DialogDescription className="text-base py-2 font-normal text-start">
                        Send this to people that you wnt to meet with. Make sure
                        that you save it so that you can use it later, too.
                    </DialogDescription>
                </DialogHeader>
                <div className="w-full">
                    <div className="flex-grow flex flex-row flex-wrap items-center justify-start gap-2">
                        <div className="relative w-full">
                            ...
                            <TooltipIconButton
                                title="Copy code"
                                className="absolute top-[50%] translate-y-[-50%] right-3 text-muted-foreground hover:text-white"
                                ghost
