                    ...
                    <CardContent>
                        <div className="w-full flex flex-col sm:flex-row items-center justify-start gap-6 mt-4">
                            <DropdownMenu>
                                <DropdownMenuTrigger asChild>
                                    <Button
                                        className="text-base gap-2 p-6 px-5 bg-blue-600 text-white hover:bg-blue-700"><Video
                                            className="h-6 w-6" /> New Meeting</Button>
                                </DropdownMenuTrigger>
                                <DropdownMenuContent className={"left-[50%]"}>
                                    <DropdownMenuItem className={"p-4 font-medium"}><Link2 className="h-6 w-6 mr-4" />Create
                                        a meeting for later</DropdownMenuItem>
                                    <DropdownMenuItem className={"p-4 font-medium"}><Plus className="h-6 w-6 mr-4" />Start
                                        an instant meeting</DropdownMenuItem>
                                    <DropdownMenuItem className={"p-4 font-medium"}><Calendar className="h-6 w-6 mr-4" />Schedule
                                        in Google Calendar</DropdownMenuItem>
                                </DropdownMenuContent>
                            </DropdownMenu>
